      ...
      items: [
        {
          ...
          achievements: [
            "**Redirected team strategy** away from highly sensitive and politically contentious issues, focusing resources and budget on student welfare initiatives.",
            "**Proposed a risk management framework** and deposit SOP to address locker access disputes, successfully restoring student usage rights.",
            ...
            "**Pushed forward a campus privacy project**, including the addition of urinal partitions to improve usability and comfort.",
            "**Revitalized open common areas** by introducing recurring community activities such as movie screenings and board games."
          ],
        ...
        },
        {
          ...
          achievements: [
            ...
            "**Used survey responses** and historical participation patterns to support demand estimation and inventory planning.",
            "**Helped secure sponsorship support** from brands including Red Bull, Monster Energy, and Taiwan Beer through proposal coordination.",
